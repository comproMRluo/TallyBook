	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="collist-group col-md-2">
			  ...
			  <a href="RecordServlet?method=getRecordByPage&pageNo=${page.pageNO}" class="list-group-item active">详细信息</a>
			  ...
			  <c:if test="${sessionScope.User.permission==0||sessionScope.User.permission==1}">
				  ...
				  <ul class="dropdown-menu">
				    ...
				    <li class="list-group-item active"><a href="RecordServlet?method=getAllRecordsByPage&pageNo=1"><b class="text-danger">查看所有的用户的消费记录</b></a></li>
						...
						<c:if test="${requestScope.page!=null}">
							<c:forEach var="page" items="${requestScope.page.list}">
									...
									<tr>
										...
										<td>${page.amount}</td>
										<td>${page.remark}</td>
										<td><a href="RecordServlet?method=delRecordByRecordid&recordid=${page.recordid}&ismanager=1">删除</a></td>
									</tr>
							</c:forEach>
					...
					<nav aria-label="Page navigation" >
					  <ul class="pagination pagination-lg">
						  ...
						  <c:if test="${page.pageNO!=1}">
						  	<li>
							  	<a href="RecordServlet?method=getAllRecordsByPage&pageNo=${page.pageNO-1}" aria-label="Previous">
						...
						<c:forEach var="i" begin="${begin}" end="${end}" step="1">
							<c:choose>
								...
								<c:otherwise>
									<li><a href="RecordServlet?method=getAllRecordsByPage&pageNo=${i}">${i}</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<c:if test="${page.pageNO!=page.totalPageNo }">
							<li>
							  <a href="RecordServlet?method=getAllRecordsByPage&pageNo=${page.pageNO+1}" aria-label="Next">
